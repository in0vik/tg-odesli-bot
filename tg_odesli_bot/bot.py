...
class OdesliBot:
    ...
    WELCOME_MSG_TEMPLATE = (
        "Hi! Send me a link to the music album, track or playlist "
    ...
    async def handle_inline_query(self, inline_query: InlineQuery) -> None:
        ...
        try:
            ...
            reply = InputTextMessageContent(
                "Sorry, soulJedi couldn't find that song", parse_mode='HTML'
            )
    ...
    async def handle_message(self, message: types.Message):
        ...
        try:
            ...
            await message.reply(
                text="Sorry, soulJedi couldn't find that song",
                parse_mode='HTML',
            )
            return
